...
// lighting
glm::vec3 lightDirection(1.2f, 0.7f, 2.0f);

QString baseDir = "D:/programmingStudy/OpenGL/Lightning-Colors/";
...
//    QApplication a(argc,argv);
    ...
    lightProgram->setVertexShaderFileName(QUrl(baseDir + "vertexshader.vert"));
