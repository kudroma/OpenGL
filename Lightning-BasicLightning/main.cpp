...
QString baseDir = "D:/programmingStudy/OpenGL/Lightning-BasicLightning/";
...
//    QApplication a(argc,argv);
            ...
            lightProgram->CompileProgram())
    {
        ...
        unsigned int objectColorLocation = glGetUniformLocation(programID,"objectColor");
        ...
        while(!glfwWindowShouldClose(window))
        {
            ...
            lightPosAfterRotation.x = angle + glm::sin(glfwGetTime())*glm::radians(360.0f);
            lightPosAfterRotation.z = angle + glm::cos(glfwGetTime())*glm::radians(360.0f);
            std::cout << lightPosAfterRotation.x << " " << lightPosAfterRotation.y << " " << lightPosAfterRotation.z << std::endl;
            ...
            glUniform3f(lightPosLocation,lightPosAfterRotation.x,lightPosAfterRotation.y,lightPosAfterRotation.z);
