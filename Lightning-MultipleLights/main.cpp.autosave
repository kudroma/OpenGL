...
int main(int argc, char* argv[])
{
            ...
            lightProgram->CompileProgram())
    {
        ...
        auto lightProgramID = lightProgram->programID();
        ...
        while(!glfwWindowShouldClose(window))
        {
            ...
            glUniform3f(dirLightAmbientLocation,0.05f,0.05f,0.05f);
            glUniform3f(dirLightDiffuseLocation,0.4f,0.4f,0.4f);
            glUniform3f(dirLightSpecularLocation,0.5f,0.5f,0.5f);

            glUniform3f(lightPositionLocation_0,
                        pointLightPositions[0].x,
                        pointLightPositions[0].y,
                        pointLightPositions[0].z);
            glUniform3f(lightAmbientLocation_0,0.05f,0.05f,0.05f);
            ...
            glUniform3f(lightAmbientLocation_1,0.05f,0.05f,0.05f);
            glUniform3f(lightDiffuseLocation_1,0.8f,0.8f,0.8f);
            glUniform3f(lightSpecularLocation_1,1.0f,1.0f,1.0f);
            glUniform1f(lightConstantLocation_1,1.0f);
            glUniform1f(lightLinearLocation_1,0.09f);
            glUniform1f(lightQuadraticLocation_1,0.032f);

            glUniform3f(lightPositionLocation_2,
                        pointLightPositions[2].x,
                        pointLightPositions[2].y,
                        pointLightPositions[2].z);
            glUniform3f(lightAmbientLocation_2,0.05f,0.05f,0.05f);
            glUniform3f(lightDiffuseLocation_2,0.8f,0.8f,0.8f);
            glUniform3f(lightSpecularLocation_2,1.0f,1.0f,1.0f);
            glUniform1f(lightConstantLocation_2,1.0f);
            glUniform1f(lightLinearLocation_2,0.09f);
            glUniform1f(lightQuadraticLocation_2,0.032f);

            glUniform3f(lightPositionLocation_3,
                        pointLightPositions[3].x,
                        pointLightPositions[3].y,
                        pointLightPositions[3].z);
            glUniform3f(lightAmbientLocation_3,0.05f,0.05f,0.05f);
            glUniform3f(lightDiffuseLocation_3,0.8f,0.8f,0.8f);
            glUniform3f(lightSpecularLocation_3,1.0f,1.0f,1.0f);
            glUniform1f(lightConstantLocation_3,1.0f);
            glUniform1f(lightLinearLocation_3,0.09f);
            glUniform1f(lightQuadraticLocation_3,0.032f);
